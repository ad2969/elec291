...
def check(val):
    if float(val) >= 18 and float(val) <= 22:
        return 1
    elif float(val) >= 28 and float(val) <= 32:
        return 2
    elif float(val) >= 38 and float(val) <= 42:
        return 3
    elif float(val) >= 48 and float(val) <= 52:
        return 4
    elif float(val) >= 58 and float(val) <= 62:
        return 5
    elif float(val) >= 68 and float(val) <= 72:
        return 6
    elif float(val) >= 78 and float(val) <= 82:
        return 7
    elif float(val) >= 88 and float(val) <= 92:
        return 8
    elif float(val) >= 98 and float(val) <= 102:
        return 9
    elif float(val) >= 108 and float(val) <= 112:
        return 10
    elif float(val) >= 118 and float(val) <= 122:
        return 11
    elif float(val) >= 128 and float(val) <= 132:
        return 12
    elif float(val) >= 138 and float(val) <= 142:
        return 13
    elif float(val) >= 148 and float(val) <= 152:
        return 14
    elif float(val) >= 158 and float(val) <= 162:
        return 15
    elif float(val) >= 168 and float(val) <= 172:
        return 16
    elif float(val) >= 178 and float(val) <= 182:
        return 17
    elif float(val) >= 188 and float(val) <= 192:
        return 18
    elif float(val) >= 198 and float(val) <= 202:
        return 19
    elif float(val) >= 208 and float(val) <= 212:
        return 20
    elif float(val) >= 218 and float(val) <= 222:
        return 21
    else:
        return 0
